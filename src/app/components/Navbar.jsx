...
const DarkMode = styled(DarkModeOutlinedIcon, { shouldForwardProp: (prop) => prop !== 'darkMode' })(
  ({ theme, darkMode }) => {
...
const NavIconButton = styled(IconButton, { shouldForwardProp: (prop) => prop !== 'darkMode' })(
  ({ theme, darkMode }) => {
    const { isDarkMode, lighttext, darktext, textColor } = darkMode || {}
            ...
            <div className="flex flex-col w-screen">
              ...
              <Box>
                <Collapse
                  in={isExpanded}
                  timeout={300}
                  sx={{ borderTop: isExpanded && `1px solid ${darkMode?.textColor}` }}
                >
                  <div>
                  ...
                  <div className="flex flex-row my-2 justify-center">
                    <MobileIconButton
                      sx={{
                        ...
                        borderRight: darkMode?.isDarkMode
                          ? `1px solid ${darkMode?.darktext}`
                          : `1px solid ${darkMode?.darktext}`,
                      }}
                      darkMode={darkMode}
                      edge="end"
                    ...
                    <MobileIconButton
                      sx={{
                        ...
                        borderLeft: darkMode?.isDarkMode
                          ? `1px solid ${darkMode?.darktext}`
                          : `1px solid ${darkMode?.lighttext}`,
                      }}
                      darkMode={darkMode}
                      edge="end"
                      color="inherit"
