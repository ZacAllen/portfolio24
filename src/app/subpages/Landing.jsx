...
const SubHeaderText = styled(Typography, { shouldForwardProp: (prop) => prop !== 'darkMode' })(
  ({ theme, darkMode }) => ({
              ...
              <TitleContainer>
                ...
                <SubHeader darkMode={darkMode}>
                  <SubHeaderText className="p-4" darkMode={darkMode}>
                    Building <span style={{ color: theme.palette.accent.complement }}>smart</span>,{' '}
                    <span style={{ color: theme.palette.primary.main }}>performant</span>, &{' '}
                    <span style={{ color: theme.palette.accent.analogous }}>accessible</span> sites worth sharing on the
                    web.
                  </SubHeaderText>
                </SubHeader>
              </TitleContainer>
